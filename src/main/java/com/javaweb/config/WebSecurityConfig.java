    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            //.antMatchers("/admin/building-edit").hasAnyRole("MANAGER")
                .antMatchers(HttpMethod.GET,"/admin/building-edit/**").hasAnyRole("ADMIN","MANAGER")
            .antMatchers("/admin/building-edit/**","/admin/building/assignment/**","/admin/building/**").hasAnyRole("ADMIN","MANAGER")
