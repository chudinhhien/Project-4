...
<c:url var="customerAPI" value="/web/customer"/>
<html>
<head>
...
<script>
    $('#btnSendContact').click(function (e) {
        ...
        $.each(formData,function (k,v){
            if(v.name === 'fullName' || v.name === 'phone'){
                if(v.value !== ''){
                    data[v.name] = v.value;
                }else {
                    window.location.href = "/lien-he?fullNameOrPhone=required"
                }
            }
            data[v.name] = v.value;
        });
    ...
    function addCustomer(data) {
        $.ajax({
            ...
            success: function(response){
                console.log("Success");
                window.location.href = "<c:url value = "/lien-he?success"/>";
            },
            error: function(res){
                console.log("Failed");
